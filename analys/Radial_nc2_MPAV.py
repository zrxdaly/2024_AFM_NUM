...
b_AG_file = sorted(glob.glob(file_dir + "/Radial_profile/Radial_Mprof.nc"))
...
np.save(file_dir + "/Radial_profile/RM_AG_RE.npy", TA_rb_AG_REF)
#%%
...
#%% save the variables for plotting
np.save(file_dir + "/Radial_profile/RM_AG_OP.npy", Rb_AG_OP)
